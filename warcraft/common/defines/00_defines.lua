...
NDiplomacy = {
	...
	WARGOAL_JUSTIFY_TENSION_FROM_PRODUCTION = 3.0,	-- Base value scaled by production capacity of country compared to biggest country
...
NProduction = {
	...
	BASE_FACTORY_SPEED_NAV = 1, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	...
	MIN_POSSIBLE_TRAINING_MANPOWER = 100,	-- How many deployment lines minimum can be training
...
NTechnology = {
	...
	BASE_TECH_COST = 15,					-- Base cost for a tech. multiplied with tech cost and ahead of time penalties
...
NBuildings = {
	...
	MAX_BUILDING_LEVELS = 10,			-- Max levels a building can have.
...
NMilitary = {
	...
	BASE_COMBAT_WIDTH = 96,                        -- base combat width
	ADDITIONAL_COMBAT_WIDTH = 32,                  -- more opened up by support attack
	...
	RIVER_CROSSING_PENALTY_LARGE = -0.2,           -- large river crossing
	...
	UNIT_EXP_LEVELS = { 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.75, 0.85, 0.9, 0.95 },		-- Experience needed to progress to the next level
...
NAI = {
	...
	CALL_ALLY_BASE_DESIRE = 100,					-- exactly what it says
	CALL_ALLY_DEMOCRATIC_DESIRE = 0,			-- Desire to call ally added for democratic AI
	CALL_ALLY_NEUTRAL_DESIRE = 0,				-- Desire to call ally added for neutral AI
	CALL_ALLY_FASCIST_DESIRE = 0,				-- Desire to call ally added for fascist AI
	CALL_ALLY_COMMUNIST_DESIRE = 0,			-- Desire to call ally added for communist AI
	JOIN_ALLY_BASE_DESIRE = 100,					-- exactly what it says
	JOIN_ALLY_DEMOCRATIC_DESIRE = 0,			-- Desire to join ally added for democratic AI
	JOIN_ALLY_NEUTRAL_DESIRE = 0,				-- Desire to join ally added for neutral AI
	JOIN_ALLY_FASCIST_DESIRE = 0,				-- Desire to join ally added for fascist AI
	JOIN_ALLY_COMMUNIST_DESIRE = 0,			-- Desire to join ally added for communist AI
	...
	GENERATE_WARGOAL_THREAT_BASELINE = 0.0,	    -- The baseline for what the AI considers the world is getting dangerous and we want to generate wargoals with no antagonize value	
	...
	FASCISTS_BEFRIEND_DEMOCRACIES = 0,
	FASCISTS_BEFRIEND_COMMUNISTS = 0,
	FASCISTS_ALLY_FASCISTS = 0,
	FASCISTS_ALLY_DEMOCRACIES = 0,
	FASCISTS_ALLY_COMMUNISTS = 0,
	FASCISTS_ANTAGONIZE_FASCISTS = 0,
	FASCISTS_ANTAGONIZE_DEMOCRACIES = 0,
	FASCISTS_ANTAGONIZE_COMMUNISTS = 0,
	DEMOCRACIES_BEFRIEND_FASCISTS = 0,
	DEMOCRACIES_BEFRIEND_DEMOCRACIES = 0,
	DEMOCRACIES_BEFRIEND_COMMUNISTS = 0,
	DEMOCRACIES_ALLY_FASCISTS = 0,
	DEMOCRACIES_ALLY_DEMOCRACIES = 0,
	DEMOCRACIES_ALLY_COMMUNISTS = 0,
	DEMOCRACIES_ANTAGONIZE_FASCISTS = 0,
	DEMOCRACIES_ANTAGONIZE_DEMOCRACIES = 0,
	DEMOCRACIES_ANTAGONIZE_COMMUNISTS = 0,
	COMMUNISTS_BEFRIEND_FASCISTS = 0,
	COMMUNISTS_BEFRIEND_DEMOCRACIES = 0,
	COMMUNISTS_BEFRIEND_COMMUNISTS = 0,
	COMMUNISTS_ALLY_FASCISTS = 0,
	COMMUNISTS_ALLY_DEMOCRACIES = 0,
	COMMUNISTS_ALLY_COMMUNISTS = 0,
	COMMUNISTS_ANTAGONIZE_FASCISTS = 0,
	COMMUNISTS_ANTAGONIZE_DEMOCRACIES = 0,
	COMMUNISTS_ANTAGONIZE_COMMUNISTS = 0,
	...
	MANPOWER_FREE_USAGE_THRESHOLD = 1,			-- If AI has this much manpower he doesn't care about the percentage
	...
	MAX_DISTANCE_NALAV_INVASION = 10000.0,				-- AI is extremely unwilling to plan naval invasions above this naval distance limit.
	...
	MAX_EXTRA_WARGOAL_GENERATION = 5,					-- AI may want to generate wargoals against weak minors to get at larger enemy, but never more that this at any given time.
	...
	MIN_FIELD_STRENGTH_TO_BUILD_UNITS = 0.01,			-- Cancel unit production if below this to get resources out to units in the field
	MIN_MANPOWER_TO_BUILD_UNITS = 0.01,					-- Cancel unit production if below this to get resources out to units in the field
...
NFocus = {
	FOCUS_POINT_DAYS = 3,						-- Each point takes a week
...
NOperatives = {
	...
	AGENCY_UPGRADE_DAYS = 7,						-- Number of days needed to upgrade an intelligence agency
	AGENCY_CREATION_FACTORIES = 2,					-- Number of factories used to create an intelligence agency
	...
	OPERATIVE_BASE_INTEL_NETWORK_GAIN = 1.0,				-- Base amount of network strength gain per day provided by an operative
